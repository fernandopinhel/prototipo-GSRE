...
$(document).ready(function() {
  ...
  $('tbody :checkbox').on('click', function() {
      ...
      .prop(
          ...
          ($(this)
            .closest('table')
            .find('tbody :checkbox:checked').length == $(this)
            .closest('table')
            .find('tbody :checkbox').length)); //Tira / coloca a seleção no .checkAll
  });
});
...
//         if ($("#tab-content-principal").hasClass("col-md-8")) {
//           $('#tab-imagens').toggle("fade").attr('class','col-md-7');
